...
%
    ...
    \subsubsection{Mitigation techniques for Urban Heat Islands}\label{ssec:mitigation}
      ...
      While high relative humidity at high temperatures has significant health risks (see \cref{sec:heatIndex})%, the amount of temperature reduced by latent heat is larger then the i 
...
\section{Comparable Definition of Urban Heat Islands}\label{sec:definition}
    ...
    \noindent\fcolorbox{gray!30}{gray!40}{%
      \parbox{\linewidth}{%
      \vspace{0.2cm}
      An \gls{SUHI} is an area with increased surface temperature within an urban space, where the temperature is at least 3 standard deviations above the average temperature of the urban adjacent rural buffer zone, corrected for larger settlements.\vspace{0.2cm}}}\\ \\
...
%
 ...
 % 
      \begin{equation}\label{equ:tiftolst}
        T_C = T_K -273.15 = \text{DN}\cdot0.00341802 + 149.0 - 273.15 
      \end{equation}
    ...
    \subsubsection{Bremen}
      ...
      \begin{figure}[!htbp]
        \begin{subfigure}[b]{\textwidth}
          \includesvg[width=\textwidth]{img/hotdaysbremen_s1940}
          \subcaption{1940-2022\label{fig:breTempExtrA}}
        \end{subfigure}
        \begin{subfigure}[b]{\textwidth}
           \includesvg[width=\textwidth]{img/hotdaysbremen_s1990}
