   ...
   \end{figure}
      ...
      \todo[inline]{maybe add weather chart for bremen of this day here?}
       ...
       \begin{landscape}
         ...
         \end{figure}
       \end{landscape}
       \Cref{fig:ndviclusters2019} and \cref{fig:ndviclusters2022} show the NDVI values of the same classes.
       ...
       This can be explained by the fact that the highly vegetated riverbank areas are also classified as water based on the additional features, changing the NDVI values assigned to this class.
...
\end{landscape}
    \subsection{Analysis}\label{sec:tempanalysis}
      ...
      The study area is at sea level elevation and has a temperate-oceanic climate according to the~\cite{koppen1930handbuch} classification.% and it's location is shown in .
  ...
  \begin{figure}[!htbp]
      ...
      The Stations are calibrated to provide comparable weather data with high levels of accuracy (error smaller $\pm 0.2°C$ \autocite{LES2024}) \cref{fig:tempurbvsrural} shows the offset of minimum, maximum and mean temperature daily temperature over the year. 
    ...
    \begin{figure}[!htbp]
      ...
      \end{figure}
          ...
          \Cref{fig:diffBre} also shows exemplary the lack of usable satellite imagery for Bremen in green. 
      Especially finding cover of the area with similar seasonal and weather patterns was difficult.
