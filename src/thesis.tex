...
\todo[inline]{Add ref to SSIM of skmeans}
  ...
  \todo[inline]{Add interpretation of SSIM}
   ...
   The urban area shown in \cref{fig:bufferedBremen} yielded a usable output shape following the Bremen city borders. 
   \Cref{fig:classesPeri} shows the classification of pixels within the peri urban area.
   It can be seen, that the pixel
