...
%
      ...
      %
        \begin{table}[ht]
          ...
          \begin{tabular}{p{1cm}p{4cm}l}
            ...
            8  & Vegetated Residential (wet) & Sparse Vegetation / Urban  \\ %TODO find solution in sw
            9  & Industrial Halls & Urban \\ 
            10 & Forests/Dense Vegetation & Forest\\
            11 & Vegetated Residential & Sparse Vegetation / Urban \\%TODO find solution in SW
            \bottomrule
        \end{tabular}
       \end{minipage}
      \end{table}
    ...
    This initial clustering served as the foundation for the subsequent Random Forest machine learning model.
      ...
      To judge quality of the clustering results the output of the K-Means and the random forest was compared to the % ESA CCI Land Use Dataset \autocite{CCCS2019} 
      ...
      %This model was validated using the Sentinel-2 300m Land Use/Land Cover map (\autocite{Zhang}).
    ...
    \subsubsection{Urban Area Extraction}
      ...
      \vspace{-2cm}
       ...
       \subcaption{Mask of the image after dilation and erosion}\label{fig:msksub}
         \includegraphics[width=0.4\textwidth]{img/FinalizedMask.png}
       \subcaption{Mask of the combined images}\label{fig:msksub}
       \end{center}
 ...
 \subsection{Analysis}\label{sec:landcoverAnalysis} 
     \begin{wrapfigure}{r}{0.5\textwidth}
     \centering
          \includesvg[width=0.45\textwidth]{img/LULC Change 2019 - 2021.svg}
   ...
   \end{wrapfigure}
      ...
      \begin{figure}[!htbp]
       \centering
          \begin{subfigure}[b]{0.45\textwidth}
            \includesvg[width=\textwidth]{img/LULC Change 2019.svg}
            \subcaption{\gls{LULC} 2019}
          \end{subfigure}
          \begin{subfigure}[b]{0.45\textwidth}
            \includesvg[width=\textwidth]{img/LULC Change 2021.svg}
            \subcaption{\gls{LULC} 2021} % TOOD CHANGE TO 2022
          \end{subfigure}
...
\section{Appendix}
  ...
  \subsubsection{Data}
    ...
    The \texttt{ML\_Model} folder contains a ``pickeled'' K-Means model, a file containing a numpy array with cluster centres for the label assignment and the random forest model. %TODO CHECK for rf
  \subsubsection{Code}
