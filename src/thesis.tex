...
Multiple studies in the 70s and 80s used images taken from planes or helicopters to aid the investigation of smaller scale effects within the urban surface temperature distribution (e.g. \cite{Landsberg1979}, \cite{ljungberg1980use} and  ).
With advances in satellite technology, resolution and data availability increased. 
The Landsat program stared in 1975 and since Landsat 4 in 1982 continuously provides thermal infrared data of the whole planet. 
