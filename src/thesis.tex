...
\section{Introduction}\label{sec:intro}
 ...
 \subsection{Research Question}
  ...
  This can help in urban planning and mitigation of \glspl{UHI} in affected urban areas.\\ %TODO this sentence 
...
% 
    ...
    The proposed threshold of at least three standard deviations above the average temperature was chosen since this gave consistent results over the seasons. %TODO verify!
 ...
 \subsection{Conclusions}
  ...
  \section{Impact of Climate Change on Urban Heat Islands}\label{sec:UHITempImp}
    \subsection{Introduction}
      ...
      % TODO One possible reason might be the lack of resilience of cities that are not encountering severe heat regularly. 
      ...
      \end{figure}
      %TODO Especially the rise in winter temperature is
