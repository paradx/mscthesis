...
\section{Comparable Definition of Urban Heat Islands}
    ...
    In~\cite{Sobrino2020} urban adjacent, future urban adjacent and peri-urban areas where used.
    The used approach was adapted by removing the urban growth projection (the paper investigated \glspl{SUHI} in 2050), to allow historical analysis of \glspl{SUHI} development.
    For \gls{LULC} Landsat 8/9 data was used combined with other data sources (see \cref{sec:svm}). 
