...
\section{Impact of Land Cover Changes on Urban Heat Islands}\label{sec:LULC}
    \subsection{Introduction}
      ...
      To answer the question (\creflabelformat{Question}{q2}) of the influence of land cover change on intensity and size of \glspl{UHI}, statistical analysis is conducted on the \glspl{UHI} within the area of Bremen. \\
    \newpage
