...
The study shows that sealed surface types are dominant in strong \glspl{UHI} (with more then 3 $\sigma$ above average temperature of the surrounding rural area).
\todo[inline]{add rest of the abstract }
\end{abstract}
